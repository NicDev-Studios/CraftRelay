...
/**
 * Asynchronous handler for one registered custom request type.
 *
...
public interface RequestHandler<Q extends NetworkMessage, R extends NetworkMessage> {
    ...
    /**
     * Handles a request away from transport and platform I/O threads.
     *
     * @param request immutable request
     * @param context public request metadata
